...
const MESSAGES = {
  "pt-BR": {
    ...
    schedule: {
      ...
      columnSortNone: "Sem ordenação",
      columnSortAsc: "A-Z",
      columnSortDesc: "Z-A",
      companyFilterSearchPlaceholder: "Buscar empresa...",
      companyFilterNoResults: "Nenhuma empresa encontrada.",
      consultantFilterSearchPlaceholder: "Buscar consultor...",
      actorFilterSearchPlaceholder: "Buscar ator...",
      ...
      actionsList: {
        title: "Ações de apontamento",
        subtitle: "Acompanhe as atuações registradas após as visitas.",
        count: "{count} ações",
        ...
        resultFilterLabel: "Resultado",
        resultFilterAll: "Todos",
        resultFilterSearchPlaceholder: "Buscar resultado...",
        sortDateDesc: "Data (mais recentes)",
        sortDateAsc: "Data (mais antigos)",
        sortCompanyAsc: "Empresa (A-Z)",
        sortActorAsc: "Ator (A-Z)",
        sortValueDesc: "Valor (maior primeiro)",
        columns: {
          company: "Empresa",
          consultant: "Consultor",
          actor: "Ator",
      ...
      dashboard: {
        ...
        actionScopeHintGeneral:
          "Visão consolidada dos atores que registraram atuação no período selecionado.",
        actionScopeHintIndividual:
          "Visão do ator selecionado com base nas ações registradas no período.",
        ...
        actionsLoadError: "Não foi possível carregar as ações.",
        ...
        selectActor: "Selecione um ator para ver a atuação.",
        ...
        actionCards: {
          actions: "Ações no período",
          actors: "Atores ativos",
          appointments: "Apontamentos atuados",
          companies: "Empresas",
          revenue: "Receita vendida",
        ...
        actionCharts: {
          resultDistribution: "Distribuição por resultado",
          statusByActor: "Resultado por ator",
          revenueByActor: "Receita por ator",
          opportunitiesByType: "Oportunidades por tipo de ação",
        ...
        tooltip: {
          ...
          actionActorLabel: "Ator: {name}",
          actionOwnerLabel: "Dono da ação: {name}",
          sharedLabel: "Compartilhado com: {name}",
          revenue: "Receita",
          lossReasons: "Motivos de perda",
          lossReasonLabel: "Motivo: {name}",
    ...
    appointment: {
      ...
      previewDialogLabel: "Visualização da imagem do apontamento",
      previewLoading: "Carregando imagem...",
      previewLoadError: "Não foi possível carregar a imagem.",
      previewTitle: "Visualização da imagem",
      attachmentOpenError: "Não foi possível abrir o anexo.",
      zoomOut: "Zoom -",
      ...
      activity: {
        analise_fluido_arref: "Análise de fluido de Arref.",
        reconexao: "Reconexão",
