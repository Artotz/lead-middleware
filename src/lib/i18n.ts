...
const MESSAGES = {
  "pt-BR": {
    ...
    schedule: {
      ...
      appointmentsControlsHint: "2 filtros e 1 ordenação",
      ...
      dashboard: {
        ...
        charts: {
          ...
          consultantAvgVisitsPerPeriod:
            "Média de visitas por período por consultor",
    ...
    createAppointment: {
      ...
      newCompanyPreview:
        "Empresa fora de carteira será criada apenas com nome.",
      ...
      createCompanyError: "Não foi possível criar a empresa.",
      createError: "Não foi possível criar o apontamento.",
      createSuccess: "Apontamento criado com sucesso.",
      pastNotAllowed: "Não é possível criar apontamento no passado.",
      collisionError: "Já existe um apontamento para esse horário.",
    },
    appointment: {
      title: "Apontamento",
      ...
      action: {
        ...
        branches: {
          ve_bayeux: "VE BAYEUX",
          ve_santana: "VE FEIRA DE SANTANA",
          ve_fortaleza: "VE FORTALEZA",
          ve_mossoro: "VE MOSSORO",
          ve_petrolina: "VE PETROLINA",
          ve_recife: "VE RECIFE",
          ve_salvador: "VE SALVADOR",
        },
      },
    },
    company: {
